...
const Terms = () => {
  return (
    <>
        <container className="flex flex-col gap-8 justify-center p-8">
      <h1 className="font-bold text-center text-2xl text-primarycolor">TERMS OF SERVICE</h1>
      <p className="font-semibold">Last updated April 15, 2024</p>
      <div>
        <h3 className="font-semibold">AGREEMENT TO OUR LEGAL TERMS</h3>

        <p>
          We are Financial Consultant ("Company," "we," "us," "our"), a company
          registered in India at Noida Sector 62 , Block A, Highway tower,
          Noida, Uttar Pradesh 201309.
        </p>

        <p>
          We operate the website financialconsultant.org.in (the "Site"), as
        ...
        <p>
          You can contact us by email at __________ or by mail to Noida Sector
          62 , Block A, Highway tower, Noida, Uttar Pradesh 201309, India.
        </p>

        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and
          Financial Consultant, concerning your access to and use of the
        ...
        <p>
          ...
          to new functionality, security updates, bug fixes, and a court order,
          in which case the changes will be effective immediately. By continuing
          to use the Services after the effective date of any changes, you agree
          to be bound by the modified terms. If you disagree with such changes,
          you may terminate Services as per the section "TERM AND TERMINATION."
        </p>
      ...
      <ul>
        ...
        <li>12. ADVERTISERS</li>
        <li>13. SERVICES MANAGEMENT</li>
        <li>14. PRIVACY POLICY</li>
        <li>15. TERM AND TERMINATION</li>
        <li>16. MODIFICATIONS AND INTERRUPTIONS</li>
        <li>17. GOVERNING LAW</li>
        <li>18. DISPUTE RESOLUTION</li>
        <li>19. CORRECTIONS</li>
        <li>20. DISCLAIMER</li>
        <li>21. LIMITATIONS OF LIABILITY</li>
        <li>22. INDEMNIFICATION</li>
        <li>23. USER DATA</li>
        <li>24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li>
        <li>25. SMS TEXT MESSAGING</li>
        <li>26. MISCELLANEOUS</li>
        <li>27. CONTACT US </li>
      </ul>
      ...
      <section>
        <h2 className="font-semibold">1. OUR SERVICES</h2>
        <p>
      ...
      <section className='flex flex-col gap-2'>
        <h2 className="font-semibold">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        ...
        <h2 className="font-semibold">Your use of our Services</h2>
      ...
      <section>
        <h2 className="font-semibold">3. USER REPRESENTATIONS</h2>
        <p>
      ...
      {/* 4. USER REGISTRATION */}
      <section>
        <h2 className="font-semibold">4. USER REGISTRATION</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">5. PURCHASES AND PAYMENT</h2>
      ...
      <section>
        <h2 className="font-semibold">6. POLICY</h2>
      ...
      <section>
        <h2 className="font-semibold">8. USER GENERATED CONTRIBUTIONS</h2>
      ...
      <section>
        <h2 className="font-semibold">9. CONTRIBUTION LICENSE</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">10. GUIDELINES FOR REVIEWS</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">11. THIRD-PARTY WEBSITES AND CONTENT</h2>
      ...
      {/*  12. ADVERTISERS*/}
      <section>
        <h2 className="font-semibold">12. ADVERTISERS</h2>
      ...
      {/* 13. SERVICES MANAGEMET */}
      <section>
        <h2 className="font-semibold">13. SERVICES MANAGEMENT</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">14. PRIVACY POLICY</h2>
        <p>
          ...
          are hosted in India. If you access the Services from any other region
      ...
      <section>
        <h2 className="font-semibold">15. TERM AND TERMINATION</h2>
      ...
      <section>
        <h2 className="font-semibold">16. MODIFICATIONS AND INTERRUPTIONS </h2>
        <p>
      ...
      {/* 17. GOVERNING LAW */}
      <section>
        <h2 className="font-semibold">17. GOVERNING LAW</h2>
        <p>
          These Legal Terms shall be governed by and defined following the laws
          of India. Financial Consultant and yourself irrevocably consent that
      ...
      <section>
        <h2 className="font-semibold">18. DISPUTE RESOLUTION</h2>
        ...
        <p>
          ...
          expressly provided below) informally for at least fifteen (15) days
        ...
        <h2 className="font-semibold">Binding Arbitration</h2>
        ...
        <p>
          ...
          India. The language of the proceedings shall be __________. The
        ...
        <h2 className="font-semibold">Exceptions to Informal Negotiations and Arbitration</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">19. CORRECTIONS</h2>
      ...
      {/* 20. DISCLAIMER */}
      <section>
        <h2 className="font-semibold">20. DISCLAIMER</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">21. LIMITATIONS OF LIABILITY</h2>
        <p>
      ...
      {/* 22. INDEMNIFICATION */}
      <section>
      <h2 className="font-semibold">22. INDEMNIFICATION</h2>
      <p>
      ...
      {/* 23. USER DATA */}
      <section>
        <h2 className="font-semibold">23. USER DATA</h2>
        <p>
      ...
      <section>
        <h2 className="font-semibold">24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        ...
        <section><h2 className="font-semibold">25. SMS TEXT MESSAGING</h2>
...
<p>
  ...
  communications, please email us at __________.
        ...
        {/* 26. MISCELLANEOUS */}
        <section>
        <h2 className="font-semibold">26. MISCELLANEOUS</h2>
        <p>
      ...
      {/* 27. CONTACT US */}
      <section>
        <h2 className="font-semibold">27. CONTACT US</h2>
        <p>
