   ...
   <>
    <nav className='sticky top-0 bg-white shadow-mdfont-fubuntu w-full flex justify-between items-center h-20'>
        ...
        <div className='flex gap-4 m-2'>  
          <SignedOut>
            <>
              <button className='bg-linkcolor hover:bg-blue-700 text-white font-bold py-1 px-4 border border-blue-700 '><Link to="/sign-in">Login</Link></button>
              <button className='bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-1 px-4 border border-blue-500 hover:border-transparent'><Link to="/sign-up">SignUp</Link></button>
          </>
          </SignedOut>
        </div>
        <div className='flex gap-4 m-2'> 
